...
int main(int argc, char *argv[])
{
    ...
    key1 = "Sirius Pro Free";                                           // 确定共享内存的密匙
    ...
    if ( readstring == "Sirius Pro Free 3.1.7" )
    {
        // 若能够读取到共享内存中的数据，则客户端已开启，不能再开启客户端
        HWND hwnd = FindWindow(NULL, L"Sirius Pro Free 3.1.7");
        ...
        sharedstring = "Sirius Pro Free 3.1.7";                         // 确定共享的数据
